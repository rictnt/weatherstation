...
class AdminCmsUsersController extends \crocodicstudio\crudbooster\controllers\CBController {
	...
	public function cbInit() {
		...
		$this->col[] = array("label"=>"Privilegios","name"=>"id_cms_privileges","join"=>"cms_privileges,name");
		...
		$this->form[] = array("label"=>"Privilegios","name"=>"id_cms_privileges","type"=>"select","datatable"=>"cms_privileges,name",'required'=>true);						
